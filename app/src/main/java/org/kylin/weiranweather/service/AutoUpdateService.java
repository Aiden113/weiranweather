package org.kylin.weiranweather.service;
...
import org.kylin.weiranweather.WeatherActivity;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int anHour =8*60*60*60*1000;//这是8小时的毫秒数
    ...
    private void updateBgImg() {
        ...
        HttpUtil.sendOkhttpRequest(requestbgImg, new Callback() {
            ...
            @Override
            public void onResponse(Call call, Response response) throws IOException {
                    String bgImg=response.body().string();
                SharedPreferences.Editor editor =PreferenceManager.getDefaultSharedPreferences(AutoUpdateService.this).edit();
                editor.putString("bg_Img",bgImg);
                editor.apply();
            }
        });
    }
